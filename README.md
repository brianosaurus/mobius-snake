...
Sample Mobius DApp Store application implemented using Ruby and the [Mobius DApp Store Ruby SDK](https://github.com/brianosaurus/mobius-client-ruby).
...
4. Open [config/secrets.yml](https://github.com/brianosaurus/floppy-bird-dapp/blob/master/config/secrets.yml) and paste the secret key in the shared/app/secret_key value.
...
Bug reports and pull requests are welcome on GitHub at https://github.com/brianosaurus/mobius-snake. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [Contributor Covenant](http://contributor-covenant.org) code of conduct.
